...
params0 = [0.0023*exp(-6.75); 0.007 ; 0.00271 ; 150];
Cond_Initiale=[4500;119;10];
options = optimset('MaxFunEvals',1500);

my_ode=@(Ici,Here) dGdI_4(Ici,Here,params0);
...
%%      OPTIMISATION DES PARAMETRES PAR LE XHI2
%{
my_ode = @(params)xhi2_4(temps,moyenne,params);
params_opt = fminsearch(my_ode,params0);

my_fit = @(Ici,Here) dGdI_4 (Ici,Here,params_opt);
...
for i = 2:11
    ...
    my_souris = @(para)xhi2_4(temps,G_souris,para);
